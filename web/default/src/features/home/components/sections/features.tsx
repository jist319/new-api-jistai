...
export function Features(_props: FeaturesProps) {
  ...
  return (
    <section className='home-section home-features relative z-10 px-6 py-24 md:py-32'>
      <div className='home-page-container mx-auto max-w-6xl'>
        ...
        {/* Bento grid */}
        <div className='home-bento border-border/40 bg-border/40 grid gap-px overflow-hidden rounded-xl border md:grid-cols-3'>
          {features.map((f, i) => (
            <AnimateInView
              key={f.id}
              delay={i * 100}
              animation='scale-in'
              className={`home-bento-item bg-background group hover:bg-muted/20 p-7 transition-colors duration-300 md:p-8 ${f.span}`}
            >
